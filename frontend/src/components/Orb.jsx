...
export default function Orb({
  ...
  propsRef.current.hue = hue;
  propsRef.current.hoverIntensity = hoverIntensity;
  propsRef.current.rotateOnHover = rotateOnHover;
  propsRef.current.forceHoverState = forceHoverState;
  propsRef.current.backgroundColor = backgroundColor;
